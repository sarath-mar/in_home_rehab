<template>
  <div id="why-home-therapy" :class="customClass">
    <v-row
      class=" banner-carousel px-5 px-md-10"
      :class="!mdAndUp ? 'margin-height' : 'mt-5 align-center main-carousel'"
    >
  <v-row  class="banner-carousel-row" >
<!-- <v-col class="content-container" cols="12" md="6"> -->
    <v-col class="text-content " cols="12" md="6" :class="!mdAndUp ? 'content-for-small-screen' : ''">
      <div v-for="(item,i) in items" :key="i">
        <div>
        <div class="content-box">
          <div v-if="activeCarousel === i" :key="`active-${activeCarousel}`" :class="{ active: shouldAnimate }">
    <h5 class="text-primary"> <span class="text-white">{{item.text}}</span>{{item.subText}}</h5>
   <h2 class="text-primary" :class="!mdAndUp ? 'pl-5' : ''">{{item.title}}</h2>
   <div class="mb-5 btn-box" :class="!mdAndUp ? 'pl-5' : ''"><v-btn class="bg-primary text-white pt-1" @click="onClick(i)">{{item.buttonText}}</v-btn></div>
   </div>
  </div>
  </div>
   </div>
   </v-col>
   <v-col class="blog-container" cols="12" md="6">
    <!-- {{active}} -->

    <v-carousel v-model="activeCarousel"  hide-delimiters show-arrows="hover" cycle>
    <v-carousel-item
    ...
    <!-- <BlogCard class="blog-card" only-image :details="slide" /> -->
   </v-col>
   <!-- </v-col> -->
   <!-- <button @click="active = !active" class="">add blog{{ active }}</button> -->
   <!-- <div class="blog-container">
    ...
    <div v-if="mdAndUp" class="mt-n10 px-5 px-md-10">
...
export default {
  components: { WelcomeForm, ColorShadeOne, StarAnimationComponent,BlogCard },
  props: {
    customClass: {
      type: String,
      required: false,
  ...
  data() {
    ...
    {
      text:"Credit Card",
      subText:"Annual Fee 5%",
      title:"Fuel your business growth with our easy loan",
      buttonText:"Get Started",
      src: 'https://www.komco.in/img/slider/Background.png',
    },
    {
      text:"Business Loan",
      subText:"Interest Rate 10%",
      title:"Get a business loan for your startup",
      buttonText:"Apply Now",
      src: 'https://www.komco.in/img/slider/slider1.jpg', 
    },
    {
      text:"Personal Loan",
      subText:"Interest Rate 12%",
      title:"Get a personal loan for your needs",
      buttonText:"Apply Now",
      src: 'https://www.komco.in/img/branches/home-kozhicode.jpg',
    },
    {
      text:"Home Loan",
      subText:"Interest Rate 8%",
      title:"Get a home loan for your dream home",
      buttonText:"Apply Now",
      src: 'https://www.komco.in/img/branches/home-palzhi.jpg',
    },
  ],
  slide:{
title:"sample test",
imgUrl:'https://cdn.vuetifyjs.com/images/carousel/planet.jpg'
  ...
  watch: {
    activeCarousel() {
      ...
      this.$nextTick(() => {
        // Small delay to ensure element is in DOM without active class
        setTimeout(() => {
...
.banner-carousel  .content-box  .active h5{
  opacity: 1;
...
.banner-carousel .content-box h2{
  display: block;
  font-size: clamp(2.4em, 3.5vw, 5em);;
  line-height: clamp(40px, 3.5vw, 3em);  
  color: #fff;
  margin-bottom: 40px;
  opacity: 0;
...
.banner-carousel .content-box .active h2{
  opacity: 1;
...
.banner-carousel .content-box .active .btn-box{
  opacity: 1;
  -webkit-transform: translateY(0);
  -moz-transform: translateY(0);
  -ms-transform: translateY(0);
...
// .creditcard-section .content-box .tab-btns{
// 	display: flex;
// 	gap: 10px;
// 	flex-wrap: wrap;
// }
...
// .inner-box.te-box-title h6:before{
//   position: absolute;
//   content: '';
...
// .tk-alternate-2 .content-box .tab-btns .tab-btn{
//   background: #141414;
...
// .tk-alternate-2 .content-box .inner-box .text-box a,
// .tk-alternate-2 .content-box .inner-box .text-box a i{
//   color: #fff;
// }
...
// .single-item.style-banner-four,
// .single-item.google-play-btn{
//   position: relative;
//   display: block;
// }
// .single-item.style-banner-four ul,
// .single-item.google-play-btn ul{
//   position: relative;
//   display: flex;
//   align-items: center;
//   justify-content: center;
...
// .single-item.google-play-btn .download-list{
//   gap: 10px;
// }

// .single-item.google-play-btn .download-list li a{
//   position: relative;
//   display: inline-block;
//   width: 56px;
//   height: 56px;
...
// .single-item.google-play-btn .download-list li a:hover{
//   background: var(--theme-color);
//   border-color: var(--theme-color);
//   color: var(--title-color);
// }
// .single-item.style-banner-four .clients-list li,
...
// .investment-block-two .inner-box .download-box a{
//   position: relative;
//   display: inline-block;
//   width: 50px;
//   height: 50px;
...
//   border-radius: 50%;
// }
// .investment-block-two .inner-box .download-box a:hover{
// 	background: #fff;
// }
...
// .tk-home-4 .banking-service .sec-title .sub-title{
//   color: #004d3f;
// }

// .tk-home-4 .banking-service .sec-title .sub-title:before,
// .tk-home-4 .banking-service .sec-title .sub-title:after{
//   background: #004d3f;
// }

// .tk-home-4 .banking-service .tab-btn .icon-box:before{
//   background: #f1f6f5;
// }

// .tk-home-4 .banking-service .tab-btn-box .owl-nav button{
//   background: #ecf1f0;
// }

// .tk-home-4 .banking-service .tab-btn-box .owl-nav button:hover{
//   background: #004d3f;
// }

// .tk-home-4 .banking-service .tab-btn:before{
//   background: var(--secondary-color);
// }

// .tk-home-4 .banking-service .content-box .inner-box h6{
//   color: var(--secondary-color);
// }

// .tk-home-4 .banking-service .list-style-one li .icon-box{
//   background: #f1f6f5;
// }

// .tk-home-4 .banking-service .content-box .lower-text h5 a,
// .tk-home-4 .banking-service .content-box .lower-text .icon-box{
//   color: var(--secondary-color);
// }

// .tk-home-4 .banking-service .content-box .inner-box .inner h6{
//   color: #a5aeac;
// }
...
// .instant-section .content-box .accordion .acc-content .single-item i{
//   position: relative;
//   display: inline-block;
//   font-size: 20px;
//   color: #c4c4c4;
...
// .instant-section .content-box .accordion .acc-content .single-item a:hover i{
//   opacity: 1;
//   color: #004D3F;
//   background-color: #fff;
//   transform: rotate(0deg);
...
// .support-inner .support-icon .shape{
//   position: absolute;
//   top: 15px;
//   right: 105px;
//   width: 68px;
...
// .tk-home-4 .support-inner .support-box{
//   background: #0f2028;
// }

// .support-inner .support-box .image-box{
//   position: relative;
//   display: block;
//   margin-right: 20px;
// }

// .support-inner .support-box .image-box img{
//   width: 100%;
// }

//  .support-inner .support-box .lower-content{
//   position: relative;
//   padding-top: 33px;
// }

// .support-inner .support-box .lower-content .big-text{
//   position: absolute;
//   right: -8px;
//   bottom: 95px;
//   font-size: 60px;
...
// .tk-home-4 .support-inner .support-box .lower-content .big-text{
//   color: #182d38;
// }

// .support-inner .support-box .lower-content .info-list li{
//   position: relative;
//   display: block;
//   font-size: 17px;
//   color: #ceb2ad;
...
// .tk-home-4 .support-inner .support-box .lower-content .info-list li{
//   color: #abb4b8;
// }

// .support-inner .support-box .lower-content .info-list li:last-child{
//   margin-bottom: 0px;
// }

// .support-inner .support-box .lower-content .info-list li a{
//   display: inline-block;
//   color: #fff;
// }

// .support-inner .support-box .lower-content .info-list li a:hover{
//   color: var(--theme-color);
// }

// .tk-home-4 .support-inner .support-box .lower-content .info-list li span{
//   color: #4b5f6a;
// }

// .support-inner .support-box .lower-content .info-list li span{
//   color: #9c6960;
// }

// .home_4 .support-inner .support-box .lower-content .theme-btn{
//   text-align: center;
//   color: var(--title-color) !important;
// }

// .tk-home-4 .support-inner .support-box .lower-content .theme-btn:hover{
//   color: #fff !important;
// }

// .tk-home-4 .support-inner .support-box .lower-content .theme-btn:before{
//   background: var(--secondary-color);
// }

// .support-inner .support-box .lower-content .theme-btn{
//   width: 100%;
// }

// .support-inner .support-box .lower-content .theme-btn:hover{
//   color: var(--title-color) !important;
// }

// .support-inner .support-box .lower-content .theme-btn:before{
//   background: #fff;
// }
...
// .tk-home-4 .working-section .working-block-one .inner-box .icon-box:before{
//   border-color: #dfe4e3;
// }

// .tk-home-4 .working-section .more-text h5 a,
// .tk-home-4 .working-section .more-text h5 i{
//   color: var(--secondary-color);
// }


// .tk-home-4 .locker-facility .sec-title .sub-title,
// .tk-home-4 .locker-facility .content-box .text-box h5 a,
// .tk-home-4 .locker-facility .content-box .text-box h5 i,
// .tk-home-4 .locker-facility .content-box .inner-box h6{
//   color: var(--secondary-color);
// }

// .tk-home-4 .locker-facility .sec-title .sub-title:before,
// .tk-home-4 .locker-facility .sec-title .sub-title:after{
//   background: var(--secondary-color);
// }

// .tk-home-4 .locker-facility .content-box .inner-box {
//   background: linear-gradient(90deg, #f1f6f5 50%, #fff 100%);
// }

// .tk-home-4 .locker-facility .content-box .inner-box h6:before,
// .tk-home-4 .te-box-title h6:before{
//   background: linear-gradient(90deg, var(--secondary-color) 0%, #f9fbfb 100%);
// }

// .tk-home-4 .locker-facility .content-box .btn-box .theme-btn{
//   background: var(--theme-color);
//   color: var(--title-color) !important;
// }

// .tk-home-4 .locker-facility .content-box .btn-box .theme-btn span:before{
//   color: var(--title-color);
// }

// .tk-home-4 .locker-facility .content-box .btn-box .theme-btn:hover,
// .tk-home-4 .locker-facility .content-box .btn-box .theme-btn:hover span:before{
//   color: #fff !important;
// }

// .tk-home-4 .locker-facility .content-box .btn-box .theme-btn:before{
//   background: var(--secondary-color);
// }
...
// .overview-section .content-box .btn-box a{
//   position: relative;
//   display: inline-block;
//   font-size: 18px;
//   line-height: 26px;
...
// .overview-section .content-box .btn-box a:hover{
//   color: var(--theme-color);
// }

// .overview-section .content-box .btn-box a svg{
//   margin-right: 10px;
// }
...
// .feature-block-one .inner-box:hover .icon-box svg,
...
// .flexi-style-list-last .documents-section .list-item li{
//   border-bottom: none;
// }
...
// .progress-content .percentage-box{
//   position: absolute;
//   left: 0px;
//   bottom: -24px;
//   width: 100%;
...
// .progress-content .percentage-box .text{
//   position: absolute;
//   top: 0px;
//   font-size: 17px;
//   line-height: 26px;
...
// .progress-content .percentage-box .text:nth-child(2){
//   right: 75%;
// }

// .progress-content .percentage-box .text:nth-child(3){
//   right: 55%;
// }

// .progress-content .percentage-box .text:nth-child(4){
//   right: 35%;
// }

// .progress-content .percentage-box .text:nth-child(5){
//   right: 15%;
// }

// .progress-content .percentage-box .text:nth-child(6){
//   right: 0%;
// }

// .progress-content .shape{
//   position: absolute;
//   left: 0px;
//   top: 20px;
//   width: 100%;
...
// .single-item.card-detail-icon-box{
//   position: relative;
//   display: block;
//   margin-bottom: 33px;
// }

// .single-item.card-detail-icon-box .icon-box{
//   position: relative;
//   display: block;
//   margin-bottom: 16px;
// }

// .single-item.card-detail-icon-box .icon-box:before{
//   position: absolute;
//   content: '';
//   background: #e6e4e4;
//   width: calc(100% - 50px);
...
// .single-item.card-detail-icon-box h3{
//   display: block;
//   font-size: 24px;
//   line-height: 32px;
//   margin-bottom: 10px;
...
// .content-four .accordion{
//   position: relative;
//   margin-bottom: 30px;
// }

// .content-four .accordion:last-child{
//   margin-bottom: 0px;
// }

// .content-four .accordion.active-block{
//   background: #f5f4f4;
// }

// .content-four .accordion .acc-btn{
//   position: relative;
//   cursor: pointer;
...
// .content-four .accordion .acc-btn.active{
//   background: var(--secondary-color);
//   border-color: var(--secondary-color);
// }

// .content-four .accordion .acc-btn.active h4{
//   color: #fff;
// }

// .content-four .accordion .acc-btn h4{
//   font-size: 20px;
//   line-height: 28px;
//   margin-bottom: 0px;
// }

// .content-four .accordion .acc-btn .icon-box{
//   position: absolute;
//   top: 0px;
//   right: 0px;
//   width: 68px;
...
// .content-four .accordion .acc-btn.active .icon-box{
//   color: var(--theme-color);
// }

// .content-four .accordion .acc-btn .icon-box i{
//   position: relative;
//   display: inline-block;
//   transition: all 500ms ease;
// }

// .content-four .accordion .acc-btn.active .icon-box i{
//   transform: rotate(180deg);
// }

// .content-four .accordion .acc-btn .icon-box:before{
//   position: absolute;
//   content: '';
//   background: #e6e4e4;
//   width: 1px;
...
// .content-four .accordion .acc-btn.active .icon-box:before{
//   background: rgba(255, 255, 255, 0.15);
// }

// .content-four .accordion .acc-content{
//   position: relative;
//   padding: 33px 30px 40px 30px;
// }

// .content-four .accordion .acc-content h5{
//   display: block;
//   font-size: 18px;
//   line-height: 26px;
//   margin-bottom: 16px;
...
// .content-four .accordion .acc-content .list-item li{
//   position: relative;
//   display: block;
//   padding-left: 35px;
//   margin-bottom: 12px;
...
// .content-four .accordion .acc-content .list-item li:last-child{
//   margin-bottom: 0px;
// }

// .content-four .accordion .acc-content .list-item li:before{
//   position: absolute;
//   content: '';
...
// .careers-block-one .inner-box .title-box .option-list li a svg,
// .careers-block-one .inner-box .title-box .option-list li button img{
//   filter: grayscale(100%);
//   transition: all 500ms ease;
// }

// .careers-block-one .inner-box .title-box .option-list li a:hover svg,
...
// .content-two .list-item li:before{
//   position: absolute;
//   content: '';
//   background: var(--theme-color);
//   width: 10px;
...
// .social-boxc .social-links li{
//   position: relative;
//   display: inline-block;
// }

// .social-boxc .social-links li a{
//   position: relative;
//   display: flex;
//   align-items: center;
//   width: 170px;
